...
<div id="k2Container" class="epb blog itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<?php if($this->params->get('catDescription')): ?>
			...
			<div class="CategoryDescription"><?php echo $this->category->description; ?></div>
			<?php endif; ?>
