...
function modChrome_FooterModules($module, &$params, &$attribs) {
    ...
    if (!empty($module->content)) {
        ?>
        <div class="footerModules moduletable<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
...
function modChrome_SidebarModules($module, &$params, &$attribs) {
    ...
    if (!empty($module->content)) {
        ?>
        <div class="sidebarModules moduletable<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
            <?php if ($module->showtitle) { ?><div class="module-title"> <h<?php echo $headerLevel; ?>><?php echo $module->title; ?></h<?php echo $headerLevel; ?>></div>
            <?php }; ?> <?php echo $module->content; ?></div>
        <?php
    };
}
