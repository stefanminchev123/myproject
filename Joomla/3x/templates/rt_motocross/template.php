...
$countblock5 = ($this->countModules('bottom1')>0) + ($this->countModules('bottom2')>0) + ($this->countModules('bottom3')>0) + ($this->countModules('bottom4')>0) + ($this->countModules('bottom5')>0);
$countblock6 = ($this->countModules('bottom6')>0) + ($this->countModules('bottom7')>0) + ($this->countModules('bottom8')>0) + ($this->countModules('bottom9')>0) + ($this->countModules('bottom10')>0);
$countblock7 = ($this->countModules('footer1')>0) + ($this->countModules('footer2')>0) + ($this->countModules('footer3')>0) + ($this->countModules('footer4')>0) + ($this->countModules('footer5')>0);
$file = JPATH_BASE.'/templates/rt_motocross/index.php';
