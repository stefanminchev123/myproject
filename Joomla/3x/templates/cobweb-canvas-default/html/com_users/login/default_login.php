...
?>
<div class="login<?php echo $this->pageclass_sfx; ?> content-form-page">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-without-legend">
		...
		<fieldset>
			<?php foreach ($this->form->getFieldset('credentials') as $field) : ?>
				<?php if (!$field->hidden) : ?>
					<div class="form-group">
						...
						<div class="controls login-label">
			...
			<div class="control-group btn-login">
				<div class="controls">
