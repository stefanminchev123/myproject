...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
    <tr>
    <td>
		<img src="<?php echo JURI::root () . 'images/logo-new.png' ?>" width="280" style="display:block; margin:15px auto;" />
<?php
//	echo vmText::sprintf('COM_VIRTUEMART_MAIL_VENDOR_CONTENT',$this->vendor->vendor_store_name,$this->shopperName,$this->currency->priceDisplay($this->orderDetails['details']['BT']->order_total,$this->currency),$this->orderDetails['details']['BT']->order_number);
	echo "Здравейте  " . $this->shopperName . ", Вие потвърдихте поръчка номер: " . $this->orderDetails['details']['BT']->order_number . " за общо " . $this->currency->priceDisplay($this->orderDetails['details']['BT']->order_total,$this->currency);
