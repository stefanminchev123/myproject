...
<html>
	...
	<style type="text/css">
	    ...
	    .cart-summary{ }
	    .html-email th { margin: 0px;padding: 10px;}
	    .sectiontableentry2, .html-email th, .cart-summary th{ margin: 0px;padding: 10px;}
	...
	<div>
	    <table style="width:80%;" cellpadding="0" cellspacing="0"  ><tr><td>
			<?php
