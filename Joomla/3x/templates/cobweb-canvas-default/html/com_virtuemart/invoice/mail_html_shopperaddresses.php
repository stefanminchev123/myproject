...
<table class="html-email" cellspacing="0" cellpadding="0" border="0" width="100%">  <tr  >
	<th width="50%" style="text-align:left; margin:10px 0;">
	    <?php echo vmText::_('COM_VIRTUEMART_USER_FORM_BILLTO_LBL'); ?>
	</th>
	<th width="50%" style="text-align:left; margin:10px 0; display: block;">
	    <?php echo vmText::_('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?>
	</th>
    </tr>
    <tr>
	<td valign="top" width="60%" style="text-align:left; margin:10px 0; display: block;">
		...
		if (!empty($field['value'])) {
			?>
			<!-- <span class="titles" style="width: 100px; display: inline-block;"><?php //echo $field['title'] ?></span> -->
