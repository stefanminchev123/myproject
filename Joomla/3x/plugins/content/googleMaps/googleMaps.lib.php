...
* v3.0.24 Nov 15, 2016 added support for google api_key
* v3.0.25 Nov 16, 2016 added method="upgrade" to install file
* changed: function Plugin_googleMaps( &$row, $pluginParams, $is_mod=0 ) {
* to: function __construct( &$row, $pluginParams, $is_mod=0 ) {
* v3.0.26 Apr 20, 2017 support for https
* v3.0.27 Jul 8, 2017 support for Joomla Update System. Tested to work with Joomla 3.7.2
* v3.0.28 Jul 8, 2017 added support for Joomla Update System. Tested to work with Joomla 3.7.3
* v3.0.29 Jul 14, 2017 added support for PHP 7
* v3.0.30 Jul 30, 2017 added support for responsive design for googleDirections and googleDirections_tohere
*/
